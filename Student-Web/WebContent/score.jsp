...
<jsp:useBean id="scoreList"
	type="com.zzzzzyx.ejb.model.ScoreListBean" scope="request"></jsp:useBean>
<jsp:useBean id="loginCount"
	type="com.zzzzzyx.ejb.model.LoginCountBean" scope="request"></jsp:useBean>
<jsp:useBean id="singleScore" class="com.zzzzzyx.ejb.model.Score"
